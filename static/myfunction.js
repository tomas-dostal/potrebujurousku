        ...
        fetch("/api/search?misto=" + searched_text)
            ...
            .then(function (myJson) {
                ...
                while(i < obj.length)
                {
                    ...
                    // jen kraj
                    if (obj[i]["city_id"] == null && obj[i]["nuts4_id"] == null && obj[i]["district_id"] == null)
                    {
                        var params = '/opatreni/?kraj_id=replace'.replace("replace", obj[i]["region_id"]);
                        ...
                        card = "<div class=\"card  text-white bg-dark \" id=\"obecmesto-obecmesto_id\"style=\"max-width: 18rem;\">\n" +
                           ...
                           // "                <h5 class=\"card-title\">Secondary card title</h5>\n" +
                            ...
                            "          </div>\n" +
                            "        </div>";
                        card = card.replace("kraj_id", obj[i]["region_id"]);
                        card = card.replace("parametry", params);
                        card = card.replace("kraj_str", obj[i]["region_name"]);
                        document.getElementById(result_element).innerHTML += card;
                    // OKRES + kraj
                    } else if (obj[i]["city_id"] == null && obj[i]["nuts4_id"] == null && obj[i]["district_id"] != null && obj[i]["region_id"] != null)
                    {
                        var params = '/opatreni/?okres_id=replace'.replace("replace", obj[i]["district_id"]);
                        ...
                        card = "<div class=\"card  text-white bg-secondary \" id=\"obecmesto-obecmesto_id\"style=\"max-width: 18rem;\">\n" +
                            ...
                            "          </div>\n" +
                            "        </div>";
                        card = card.replace("okres_id", obj[i]["district_id"]);
                        card = card.replace("parametry", params);
                        card = card.replace("okres_str", obj[i]["district_name"]);
                        card = card.replace("kraj_str", obj[i]["region_name"]);
                        document.getElementById(result_element).innerHTML += card;
                    ...
                    {
                        var params = '/opatreni/?nuts3_id=replace'.replace("replace", obj[i]["nuts4_id"]);
                        ...
                        card = "<div class=\"card  bg-light \" id=\"obecmesto-obecmesto_id\"style=\"max-width: 18rem;\">\n" +
                            ...
                            "          </div>\n" +
                            "        </div>";
                        card = card.replace("nuts_id", obj[i]["nuts4_id"]);
                        card = card.replace("parametry", params);
                        card = card.replace("okres_str", obj[i]["district_name"]);

                        card = card.replace("nuts3_str", obj[i]["nuts4_name"]);
                        card = card.replace("kraj_str", obj[i]["region_name"]);
                        document.getElementById(result_element).innerHTML += card;
                    // obecmesto
                    } else if (obj[i]["city_id"] != null && obj[i]["nuts4_id"] != null && obj[i]["district_id"] != null && obj[i]["region_id"] != null)
                    {
                        ...
                        var params = '/opatreni/?obecmesto_id=replace'.replace("replace", obj[i]["city_id"]);
                        ...
                        card = "<div class=\"card  bg-light \" id=\"obecmesto-obecmesto_id\"style=\"max-width: 18rem;\">\n" +
                                    ...
                                    "        </div>";
                        card = card.replace("parametry", params);
                        card = card.replace("obecmesto_id", obj[i]["city_id"]);
                        card = card.replace("obecmesto_str", obj[i]["city_name"]);
                        card = card.replace("okres_str", obj[i]["district_name"]);
                        card = card.replace("nuts_str", obj[i]["nuts4_name"]);
                        card = card.replace("kraj_str", obj[i]["region_name"]);
                        document.getElementById(result_element).innerHTML += card;
                    }
                    i = i + 1;
