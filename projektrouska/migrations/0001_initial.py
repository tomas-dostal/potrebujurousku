# Generated by Django 3.1 on 2020-12-14 00:08
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content_type', models.CharField(choices=[('URL', 'URL link to general content'), ('PDF', 'URL link to PDF'), ('IMG', 'URL link to IMAGE'), ('VID', 'URL link VIDEO')], default='URL', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('info', 'Information, not requiered to be complienced'), ('warning', 'Recommendation, not requiered to be complienced'), ('danger', 'Regulation, requiered to be complienced'), ('black', 'Emergency regulation, requiered to be complienced')], default='danger', max_length=15)),
                ('modal_size', models.CharField(choices=[('modal-sm', 'Small'), ('modal-md', 'Medium'), ('modal-lg', 'Large')], default='modal-md', max_length=15)),
                ('icon', models.CharField(blank=True, max_length=40, null=True)),
                ('cathegory', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='projektrouska.cathegory')),
                ('external_contents', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='projektrouska.externalcontent')),
            ],
            options={
                'db_table': 'part',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('1', 'Active (auto)'), ('0', 'Disabled (auto)'), ('3', 'Active (force)'), ('4', 'Disabled (force)'), ('2', 'Active (check required)'), ('5', 'Disabled (maintenance in progress)')], default='1', max_length=2)),
                ('priority', models.IntegerField(choices=[(-1, 'Not filled'), (0, 'Redundant (it is here just to auto-check to be satisfied)'), (1, 'It might be useful'), (10, 'Slightly important information, good to know'), (100, 'Important information, have to know'), (1000, 'Extremely important')], default=-1)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pes_general', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='projektrouska.pes_general')),
